        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        <form action="{{ route('process_register') }}" id="register_form" class="signin-form" method="POST" novalidate>
                            @csrf
            ...
            <div class="row justify-content-center">
                <div class="mt-4 text-center">
                    <a href="{{ route('login') }}" style="font-size: 2rem">Đã có tài khoản? Đăng nhập tại đây</a>
                </div>
            </div>
        </div>
    </section>
