        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        <form action="{{ route('process_login') }}" id="login_form" class="signin-form" method="POST" novalidate>
                            @csrf
            ...
            <div class="row justify-content-center">
                <div class="mt-4 text-center">
                    <a href="{{ route('register') }}" style="font-size: 2rem">Chưa có tài khoản tại Foodee? Đăng ký ngay</a>
                </div>
            </div>
        </div>
    </section>
