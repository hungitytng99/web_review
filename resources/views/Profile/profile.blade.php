                            ...
                            <div class="row pb-4">
                                <div class="col">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="btn danger ml-auto mb-0" data-toggle="modal"
                                            data-target="#staticBackdrop">Xoá tài khoản...</span>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="d-flex align-items-center section-save-change-btn">
                                <input type="submit" form="name_form" class="btn primary shadow-sm ml-auto"
                                    value="Lưu thay đổi">
                            </div>
                            ...
                            <div class="row pb-4">
                                <div class="col-md">
                                    ...
                                    <input type="date" class="form-control" id="date_of_birth" name="date_of_birth"
                                        value="{{ Auth::user()->date_of_birth ?? '' }}" min="1800-01-01"
                                        max="2021-12-31">
                                </div>
                                <div class="col-md">
                                    <div class="section-input-label d-flex justify-content-between">
                        ...
                        <form action="{{ url('/profile') }}" method="POST">
                            ...
                            <div class="row pb-4">
                                <div class="col">
                                    ...
                                    <div class="alert alert-danger" id="alert_retype_new_password" role="alert" hidden>
                                    </div>
                                </div>
                            </div>
                            <hr>
